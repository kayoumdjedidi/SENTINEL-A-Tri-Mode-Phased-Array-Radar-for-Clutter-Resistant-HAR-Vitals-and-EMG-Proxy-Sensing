...
RF_MAX = 10.5e9
RF_DEFAULT = 10.0e9          # Desired radiated RF (Hz)
...
FFT_SPAN_HZ = 5000           # Wider default span around tone
WF_SPAN_HZ = 5000            # Match waterfall span
...
class Window(QMainWindow):
    ...
    def apply_settings(self):
        ...
        global rx_gain_ch0, rx_gain_ch1, tx_gain_ch1
        global tx_scale_ch1
        ...
        # Keep routing asserted after any GUI change
        _route_tx_out2_and_lo()
...
timer.start(50)  # ms; quicker refresh with smaller FFT
